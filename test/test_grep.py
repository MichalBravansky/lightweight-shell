...
class TestGrep(unittest.TestCase):
    ...
    def test_grep_single_file(self):
        ...
        file_arg = Argument(Argument.LIST, "files", [str(self.temp_path / "file1.txt")])
    ...
    def test_grep_no_file_with_input(self):
        ...
        response = Grep().execute({"pattern": pattern_arg, "files": Argument(Argument.LIST, "files", [])}, input=input_text)
