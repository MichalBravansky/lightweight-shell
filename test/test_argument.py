...
class TestArgument(unittest.TestCase):
    ...
    def test_missing_value_error(self):
        args_info = {
            "positional_args": [],
            "named_args": {"n": Argument(Argument.FLAG_WITH_INTEGER, "number")}
        }
    ...
    def test_flag_with_value(self):
        args_info = {
            "positional_args": [],
            "named_args": {"limit": Argument(Argument.FLAG_WITH_INTEGER, "limit")}
        }
    ...
    def test_list_argument(self):
        ...
        self.assertEqual(result["positional_args"][0].value, ["item1", "item2", "item3"])

    def test_combined_arguments(self):
        args_info = {
            "positional_args": [Argument(Argument.STRING, "name"), Argument(Argument.INTEGER, "age")],
    ...
    def test_only_positional_arguments(self):
        args_info = {
            "positional_args": [Argument(Argument.STRING, "first"), Argument(Argument.INTEGER, "second")],
            "named_args": {}
        }
