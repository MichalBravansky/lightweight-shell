    ...
    def execute(self, args, input=None) -> None:
        ...
        Args:
            args (dict): A dictionary containing the command arguments.
                - 'recursive' (bool): Indicates whether to remove files recursively.
                - 'paths' (list): A list of paths to be removed.
            input (str, optional): Input string. Not used in this method.

        Raises:
            FileNotFoundError: If the specified path does not exist.
            IsADirectoryError: If the specified path is a directory and 'remove_directory' is False.
        ...
        for path in paths:
            ...
            if os.path.isfile(path):
                ...
                raise IsADirectoryError(f"rm: {path} is a directory. Use -r to remove it.")