...
class ShellParser(Parser):
        ...
        def redirection(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    ShellParser.RedirectionContext
                )
            else:
                return self.getTypedRuleContext(
                    ShellParser.RedirectionContext, i
                )
    ...
    class RedirectionContext(ParserRuleContext):
        ...
        def redirectionType(self):
            return self.getTypedRuleContext(
                ShellParser.RedirectionTypeContext, 0
            )
    ...
    class ArgumentContext(ParserRuleContext):
        ...
        def quotedArg(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    ShellParser.QuotedArgContext, i
                )
    ...
    def redirectionType(self):
        localctx = ShellParser.RedirectionTypeContext(
