...
RUN chmod u+x /comp0010/tools/test_github_actions
RUN chmod u+x /comp0010/tools/coverage
RUN chmod u+x /comp0010/tools/coverage_github_actions
RUN chmod u+x /comp0010/tools/analysis
RUN chmod u+x /comp0010/tools/analysis_github_actions
